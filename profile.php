...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>Link</b>Instag</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $user->data()->username; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              ...
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="#">Followers <span class="pull-right badge bg-red">842</span></a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="#">Likes <span class="pull-right badge bg-red">842</span></a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="#">Friends <span class="pull-right badge bg-red">842</span></a>
                  </div>
                </div>
                <!-- /.row -->
              </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          <a href="#" data-toggle="modal" data-target="#modal-default">
            <i class="fa fa-send"></i> <span>Post</span>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-circle-o"></i> Friend 3</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Friend 4</a></li>
          </ul>
        </li>
        <li class="treeview">
                ...
                <div class="post">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="../../dist/img/user1-128x128.jpg" alt="user image">
                        <span class="username">
                          <a href="#"><?php echo $user->data()->name; ?></a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">LinkStag</a>.</strong> All rights
    reserved.
  </footer>
  <!-- /.control-sidebar -->
...
<?php require_once 'include/post-modal.php'; ?>
<!-- jQuery 3 -->
